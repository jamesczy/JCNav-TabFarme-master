...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.moveBackBtn =  [self setupBtn:@"movieBackward@2x.png" hightImage:@"movieBackwardSelectedb@2x.png" type:JCPlayPauseViewButtonTypeBackward];
        self.playPauseBtn =  [self setupBtn:@"moviePause.png" hightImage:@"moviePlay.png" type:JCPlayPauseViewButtonTypePlayPause];
        self.moveForwordBtn = [self setupBtn:@"movieForward@2x.png" hightImage:@"movieForwardSelectedb@2x.png" type:JCPlayPauseViewButtonTypeForward];
